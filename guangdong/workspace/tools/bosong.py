...
def aug_normal(defect_img_path,normal_img_path,transform):
    ...
    save_augimg_path=osp.join(img_path,'origin_auged_img/')
    ...
    for img in normal_img_list:
        ...
        for j in range(15):
            ...
            print("save##########")
    json_name="/home/xiongpan/dataset/flaw-detection/tile_round1_train_20201231/tile_round1_train_20201231/cam1/aug_flaw_ori_json.json"
    with open(json_name,'w') as fp:
        json.dump(result,fp,indent=4,separators=(',',':'))

if __name__=="__main__":
    img_path="/home/xiongpan/dataset/flaw-detection/tile_round1_train_20201231/tile_round1_train_20201231/cam1/train_img"
    defect_img_path="/home/xiongpan/dataset/flaw-detection/tile_round1_train_20201231/tile_round1_train_20201231/cam1/flaw_img/3"
